# -*- coding: utf-8 -*-
"""
Created on Mon May 18 19:29:22 2026

@author: axlea
"""

#Uncomment to test class Podcast (select next 4 lines and press ctrl-1)
from classes.podcast import Podcast
test_class = Podcast
ob = '0;Technology;Tech Talks;10/01/2024'
db = 'DadaBase_Podcast.db'

#Uncomment to test class Guest (select next two lines and press ctrl-1)
# from classes.guest import Guest
# test_class = Guest
# ob = '0;Joaquim Silva'

#Uncomment to test class Theme
# from classes.theme import Theme
# test_class = Theme
# ob='0;Technology;1'

#Uncomment to test class Sponsor
# from classes.sponsor import Sponsor
# test_class = Sponsor
# ob='0;extra info test;1'

#Uncomment to test class Participation
# from classes.participation import Participation
# test_class = Participation
# ob='0;10/01/2024;500;1;1'
