...
if len(Podcast.lst) == 0:
    ...
    p2 = Podcast(0, 'Science', 'Ciencia Viva', '15/02/2024')
...
if len(Theme.lst) == 0:
    t1 = Theme(0, 'Technology', first_podcast_id)
    Theme.insert(t1.id)
...
if len(Sponsor.lst) == 0:
    s1 = Sponsor(0, 'extra info test', first_podcast_id)
...
if len(Participation.lst) == 0:
    par1 = Participation(0, '10/01/2024', 500, first_podcast_id, first_guest_id)
